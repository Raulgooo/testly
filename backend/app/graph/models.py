...
import operator
from .lang_logic import merge_book_state
...
class BookState(BaseModel):
    ...
    chapter_analyses: Annotated[List[ChapterAnalysis], operator.add] = [] 
    #operator.add does nothing because it is hijacked by merge_book_state

class ProcessState(BaseModel):
    book_parse_state: Annotated[BookState, merge_book_state] = Field(default_factory=BookState)
